...
define('sayyes/modules/core',['require','zepto/zepto','zepto/data','zepto/event','zepto/touch','zepto/detect','zepto/form','zepto/ajax','req/require'],function (require) {
	require("zepto/zepto");
	require("zepto/data");
	require("zepto/event");
	require("zepto/touch");
...
define('sayyes/test-specs/spec-model',["sayyes/util/model"], function(model) {
	var blob;
...
define('sayyes/test-specs/spec-vos',[
...
define('mout/array/every',['../function/makeIterator_'], function (makeIterator) {
...
*/
define('sayyes/test-specs/spec-ajax',["sayyes/util/ajax"], function(ajax) {
	var xhr;
...
define('sayyes/test-specs/spec-log',["sayyes/util/log"], function(log) {
	window.log = log;
...
define("sayyes/test-specs/specs", function(){});

//# sourceMappingURL=test-spec-min.js.map